...
?>
<div class="work-one <?php print implode(' ', $categories); ?> ">
  <div class="work-title col-sm-4 col-md-4">
    <h3 class="title"><a href="<?php print $fields['path']->content; ?>"><?php print $fields['title']->content; ?></a></h3>
    <div class="description"><?php print str_replace('[separator]', ', ', $fields['field_category']->content); ?></div>
    <p><?php print $fields['body']->content; ?></p>
  </div>
  <div class="col-sm-8 col-md-8">
    <a href="<?php print $fields['path']->content; ?>" class="work-image">
